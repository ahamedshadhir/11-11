...
def safe_login():
    ...
    try:
        ...
        known = {'demo@1111.local': 'demo123', admin_email: admin_pw}
        ...
        if user is None and allowed:
            user = User(
                name='Demo User' if email.startswith('demo') else 'Store Admin',
                email=email,
...
app.view_functions['login'] = safe_login
if 'user_login' in app.view_functions:
    app.view_functions['user_login'] = safe_login
